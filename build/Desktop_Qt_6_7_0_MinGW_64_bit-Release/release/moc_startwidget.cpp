...
struct qt_meta_stringdata_CLASSStartWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStartWidgetENDCLASS = QtMocHelpers::stringData(
    "StartWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStartWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StartWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStartWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStartWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStartWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *StartWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStartWidgetENDCLASS.stringdata0))
